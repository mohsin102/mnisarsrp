({
    ...
    populateSelectedValues: function(component,event,helper){
        
        var action = component.get("c.getSelectedValues");

		action.setParams({
			'api10Values': component.get('v.revenuePropertyRecord').Id
		});
		...
		action.setCallback(this, function(response){
            ...
            component.set('v.selection', responseValue);
		});
