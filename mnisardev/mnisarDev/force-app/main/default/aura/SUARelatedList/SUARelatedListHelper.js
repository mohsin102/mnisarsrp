({
    ...
    component.set('v.mycolumns', [
           {label: 'Account', fieldName: 'AccountLink', type: 'url', cellAttributes: { alignment: 'left' }, 
            ...
            { label: 'Allocation Factor', fieldName: 'allocationFactorComputed__c', type: 'number', cellAttributes: { alignment: 'left' },typeAttributes: { minimumFractionDigits : '8' }, sortable: true },
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set("v.data", finalArray);
