({
    ...
    init : function(component, event, helper) {
        ...
        if(component.get('v.isAssociated')===false){
            component.set('v.columns', [
                ...
                {label: 'Line Item Decimal', fieldName: 'lineItemDecimal__c', type: 'number', typeAttributes: { minimumFractionDigits : '8' }, cellAttributes: { alignment: 'left' }},
                ...
                {label: 'Revenue Allocated', fieldName: 'revenueAllocated__c', type: 'boolean',sortable: true}
            ]);
    ...
    handleSave: function(component, event, helper){
        ...
        action.setParams({ 
            'wellIds': wellSet,
            'propertyName': component.get('v.revenueProperty').Id,
    ...
    openRecord: function(component,event,hedlper){
        var navEvt = $A.get("e.force:navigateToSObject");
        navEvt.setParams({
          "recordId": component.get('v.revenueProperty').Id,
          "slideDevName": "detail"
        });
        navEvt.fire();
    }
